  ...
  <RevealAnimation delay={delay}>
    <div className="relative">
      <div className="flex items-start gap-6">
        <div className="relative">
          <div className="bg-gold text-dark-charcoal rounded-full w-14 h-14 flex items-center justify-center font-bold text-xl z-10 relative">
            {number}
          </div>
          {number < 3 && (
            <div className="absolute top-14 left-1/2 transform -translate-x-1/2 w-0.5 h-16 bg-gold/30"></div>
          )}
        </div>
...
const HowToJoin: React.FC = () => {
  return (
    <section id="request-invite" className="py-20 bg-gradient-to-b from-dark-charcoal to-deep-navy relative">
      {/* Background accent */}
      <div className="absolute top-0 left-1/4 w-1/2 h-1/2 bg-deep-teal/5 rounded-full blur-3xl"></div>
      
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-16">
          <RevealAnimation>
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-white font-playfair">
              How to <span className="text-gold">Join the Network</span>
            </h2>
          </RevealAnimation>
